...
namespace MeshGenerator.Modelling.Solutions.Dynamic
{
    public class DynamicMechanicSparseSolution : ISolution
    {
        ...
        public DynamicMechanicSparseSolution(ISolve<SparseMatrix> solver, FeModel model)
        {
            this.solver = solver;
        ...
        public DynamicMechanicSparseSolution(ISolve<SparseMatrix> solver, IScene scene)
        {
            this.solver = solver;
            globalMatrix = solver.GlobalMatrix;
        ...
        public void Solve(TypeOfFixation type, IBoundaryCondition conditions, ILoad load)
        {
            ...
            Array.Copy(vectorResults.ToArray(), results, length);
