...
namespace AditionalToolkit
{
    ...
    public static class STLExport
    {
        ...
        */
        ...
        public static float[] Get_Mesh_Colors(TriangleMesh[] meshArray)
        {
            ...
            {
                /* color 1 */
                colors.Add(meshArray[i].col1.R);
                colors.Add(meshArray[i].col1.G);
                colors.Add(meshArray[i].col1.B);
                /* color 2 */
                colors.Add(meshArray[i].col2.R);
                colors.Add(meshArray[i].col2.G);
                colors.Add(meshArray[i].col2.B);
                /* color 3 */
                colors.Add(meshArray[i].col3.R);
                colors.Add(meshArray[i].col3.G);
                colors.Add(meshArray[i].col3.B);
            }
