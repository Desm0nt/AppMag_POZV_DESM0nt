...
namespace App
{
    public partial class ResultView : Form
    {
        ...
        public ResultView(string value)
        {
            InitializeComponent();
        ...
        {
            key = true;
            prevX = Convert.ToSingle(e.Location.X);
            prevY = Convert.ToSingle(e.Location.Y);
        }
        ...
        private void openGlControl_MouseMove(object sender, MouseEventArgs e)
        {
            if (key)
            {
                float dx = (prevX - Convert.ToSingle(e.Location.X)) / 40;
                float dy = (prevY - Convert.ToSingle(e.Location.Y)) / 40;
                prevX = Convert.ToSingle(e.Location.X);
                prevY = Convert.ToSingle(e.Location.Y);
